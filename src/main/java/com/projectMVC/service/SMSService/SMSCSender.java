package com.projectMVC.service.SMSService;
...
public class SMSCSender {
    ...
    private String SMSC_LOGIN    = "katashinsky";    // логин клиента
    private String SMSC_PASSWORD = "DIMOn4523";    // пароль или MD5-хеш пароля в нижнем регистре
